...
class __TwigTemplate_8876604e9f462fb90a30aefe404e7af1 extends Template
{
    private $source;
    private $macros = [];
...
{%- macro render_table_triggered_handlers(handlers) -%}
    ...
    {%- endfor -%}
{%- endmacro -%}
", "@JMSSerializer/Collector/handlers.html.twig", "/home/emilio/app/vendor/jms/serializer-bundle/Resources/views/Collector/handlers.html.twig");
    }
}
