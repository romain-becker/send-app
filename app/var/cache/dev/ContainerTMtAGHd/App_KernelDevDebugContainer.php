...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected function getSecurity_Firewall_MapService()
    {
        return $this->privates['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(($this->privates['.service_locator.499SnRR'] ?? $this->get_ServiceLocator_499SnRRService()), new RewindableGenerator(function () {
            ...
            yield 'security.firewall.map.context.orders' => ($this->privates['.security.request_matcher.s2_hFmr'] ?? ($this->privates['.security.request_matcher.s2_hFmr'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/orders$', NULL, [0 => 'GET'])));
