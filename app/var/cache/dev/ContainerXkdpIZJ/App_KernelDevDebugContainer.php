...
class App_KernelDevDebugContainer extends Container
{
    ...
    /**
     * Gets the private '.service_locator.499SnRR' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_499SnRRService()
    {
        return $this->privates['.service_locator.499SnRR'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'security.firewall.map.context.carts' => ['privates', 'security.firewall.map.context.carts', 'getSecurity_Firewall_Map_Context_CartsService', true],
            'security.firewall.map.context.carts_id' => ['privates', 'security.firewall.map.context.carts_id', 'getSecurity_Firewall_Map_Context_CartsIdService', true],
            ...
            'security.firewall.map.context.orders' => ['privates', 'security.firewall.map.context.orders', 'getSecurity_Firewall_Map_Context_OrdersService', true],
            'security.firewall.map.context.orders_id' => ['privates', 'security.firewall.map.context.orders_id', 'getSecurity_Firewall_Map_Context_OrdersIdService', true],
            'security.firewall.map.context.products' => ['privates', 'security.firewall.map.context.products', 'getSecurity_Firewall_Map_Context_ProductsService', true],
            'security.firewall.map.context.products_id' => ['privates', 'security.firewall.map.context.products_id', 'getSecurity_Firewall_Map_Context_ProductsIdService', true],
            'security.firewall.map.context.users' => ['privates', 'security.firewall.map.context.users', 'getSecurity_Firewall_Map_Context_UsersService', true],
        ], [
            'security.firewall.map.context.carts' => '?',
            'security.firewall.map.context.carts_id' => '?',
            'security.firewall.map.context.dev' => '?',
            'security.firewall.map.context.login' => '?',
            'security.firewall.map.context.main' => '?',
            'security.firewall.map.context.orders' => '?',
            'security.firewall.map.context.orders_id' => '?',
            'security.firewall.map.context.products' => '?',
            'security.firewall.map.context.products_id' => '?',
            'security.firewall.map.context.users' => '?',
        ]);
    }
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('UyCdiWmwmm', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    protected function getSecurity_ContextListener_0Service()
    {
        return $this->privates['security.context_listener.0'] = new \Symfony\Component\Security\Http\Firewall\ContextListener(($this->privates['security.untracked_token_storage'] ?? ($this->privates['security.untracked_token_storage'] = new \Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorage())), new RewindableGenerator(function () {
            yield 0 => ($this->privates['security.user.provider.concrete.in_database'] ?? $this->load('getSecurity_User_Provider_Concrete_InDatabaseService'));
    ...
    {
        return $this->privates['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(($this->privates['.service_locator.499SnRR'] ?? $this->get_ServiceLocator_499SnRRService()), new RewindableGenerator(function () {
            yield 'security.firewall.map.context.dev' => ($this->privates['.security.request_matcher.Iy.T22O'] ?? ($this->privates['.security.request_matcher.Iy.T22O'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/')));
            yield 'security.firewall.map.context.login' => ($this->privates['.security.request_matcher.huI_Dm8'] ?? ($this->privates['.security.request_matcher.huI_Dm8'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/login$')));
            yield 'security.firewall.map.context.users' => ($this->privates['.security.request_matcher.aLf9S8V'] ?? ($this->privates['.security.request_matcher.aLf9S8V'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/users$', NULL, [0 => 'PUT', 1 => 'GET'])));
            yield 'security.firewall.map.context.products' => ($this->privates['.security.request_matcher.8z1_i0X'] ?? ($this->privates['.security.request_matcher.8z1_i0X'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/products$', NULL, [0 => 'GET', 1 => 'POST'])));
            yield 'security.firewall.map.context.products_id' => ($this->privates['.security.request_matcher.n4BLKWj'] ?? ($this->privates['.security.request_matcher.n4BLKWj'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/products/{id}$', NULL, [0 => 'PUT', 1 => 'DELETE'])));
            yield 'security.firewall.map.context.carts' => ($this->privates['.security.request_matcher.PGV3tPe'] ?? ($this->privates['.security.request_matcher.PGV3tPe'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/carts$', NULL, [0 => 'GET'])));
            yield 'security.firewall.map.context.carts_id' => ($this->privates['.security.request_matcher.DLTf6qY'] ?? ($this->privates['.security.request_matcher.DLTf6qY'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/carts/{id}$', NULL, [0 => 'POST', 1 => 'DELETE'])));
            yield 'security.firewall.map.context.orders' => ($this->privates['.security.request_matcher.UvNQitn'] ?? ($this->privates['.security.request_matcher.UvNQitn'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/orders$, ^api/orders/{id}$', NULL, [0 => 'GET'])));
            yield 'security.firewall.map.context.orders_id' => ($this->privates['.security.request_matcher.0zYwmIU'] ?? ($this->privates['.security.request_matcher.0zYwmIU'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^api/orders/{id}$', NULL, [0 => 'GET'])));
